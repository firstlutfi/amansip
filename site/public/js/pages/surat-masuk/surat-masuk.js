		...
		$.ajax({
            ...
            success: function (data) {
                if (data.tipe_surat == 1) {
					...
					$("#view-disposisi-surat-biasa").html(data.disposisi);
					$("#view-isi-disposisi-surat-biasa").html(data.isi_disposisi);
					$("#modals-view").modal('show');
					...
					$("#view-disposisi-surat-undangan").html(data.disposisi);
					$("#view-isi-disposisi-surat-undangan").html(data.isi_disposisi);
					$("#modals-view").modal('show');
				}
            },
            error: function () {
		...
		$.ajax({
            ...
            success: function (data) {
                ...
                if (data.tipe_surat == 1) {
					...
					if (data.disposisi == 1) {
						$("#edit-disposisi-surat-biasa-1").attr("selected", true);
					}else if (data.disposisi == 2) {
						$("#edit-disposisi-surat-biasa-2").attr("selected", true);
					}else{
						$("#edit-disposisi-surat-biasa-3").attr("selected", true);
					}
					$("#edit-isi-disposisi-surat-biasa").val(data.isi_disposisi);
					$("#modals-edit").modal('show');
				}else if (data.tipe_surat == 4) {
					$("#form-edit-surat-perintah").hide();
					$("#form-edit-surat-edaran").hide();
					...
					if (data.disposisi == 1) {
						$("#edit-disposisi-undangan-1").attr("selected", true);
					}else if (data.disposisi == 2) {
						$("#edit-disposisi-undangan-2").attr("selected", true);
					}else{
						$("#edit-disposisi-undangan-3").attr("selected", true);
					}
					$("#edit-isi-disposisi-undangan").val(data.isi_disposisi);
					$("#modals-edit").modal('show');
				}
            },
            error: function () {
