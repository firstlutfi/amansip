            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('action-update-surat') }}" method="post" enctype="multipart/form-data" role="form" id="form-edit-surat-biasa" style="display:none">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group form-md-line-input form-md-floating-label ">
                            <select class="form-control" name="select-disposisi-kepada-surat-biasa" id="edit-select-disposisi-kepada-surat-biasa" required>
                                <option value="1" id="edit-disposisi-surat-biasa-1">Kasi Dukkesops</option>
                                <option value="2" id="edit-disposisi-surat-biasa-2">Kasi Bankes</option>
                                <option value="3" id="edit-disposisi-surat-biasa-3">Kasi Nubika</option>
                            </select>
                            <label for="select-disposisi-kepada-surat-biasa">Disposisi Kepada</label>
                        </div>
                        <div class="form-group form-md-line-input form-md-floating-label ">
                            <input type="text" class="form-control edited" name="isi-disposisi-surat-biasa" id="edit-isi-disposisi-surat-biasa" required>
                            <label for="edit-isi-disposisi-surat-biasa">Isi Disposisi</label>
                        </div>
                        <div class="form-group form-md-line-input">
                            <label for="file-surat">Upload Berkas</label>
                            <input type="file" name="file-surat" id="file-surat" class="dropify" 
                ...
                <form action="{{ route('action-update-surat') }}" method="post" enctype="multipart/form-data" role="form" id="form-edit-undangan" style="display:none">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group form-md-line-input form-md-floating-label ">
                            <select class="form-control" name="select-disposisi-kepada-undangan" id="edit-select-disposisi-kepada-undangan" required>
                                <option value="1" id="edit-disposisi-undangan-1">Kasi Dukkesops</option>
                                <option value="2" id="edit-disposisi-undangan-2">Kasi Bankes</option>
                                <option value="3" id="edit-disposisi-undangan-3">Kasi Nubika</option>
                            </select>
                            <label for="edit-select-disposisi-kepada-undangan">Disposisi Kepada</label>
                        </div>
                        <div class="form-group form-md-line-input form-md-floating-label ">
                            <input type="text" class="form-control edited" name="isi-disposisi-undangan" id="edit-isi-disposisi-undangan" required>
                            <label for="edit-isi-disposisi-undangan">Isi Disposisi</label>
                        </div>
                        <div class="form-group form-md-line-input">
                            <label for="file-surat">Upload Berkas</label>
                            <input type="file" name="file-surat" id="file-surat" class="dropify" 
