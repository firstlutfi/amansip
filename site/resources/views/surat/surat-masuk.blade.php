...
@section('page-content')
	<div class="page-content">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase">View All Surat Masuk</span>
                                        </div>
                                        <div class="tools"> </div>
                                    </div>
                    ...
                    @include('surat.modals-create-surat-masuk')
                    @include('surat.modals-view-surat-masuk')
                    @include('surat.modals-edit-surat-masuk')
@endsection
...
<script src="js/pages/surat-masuk/surat-masuk.js" type="text/javascript"></script>
@endsection