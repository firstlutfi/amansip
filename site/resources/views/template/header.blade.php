...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>AMAN SIP - @yield('page-title')</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport">
        <meta content="Aplikasi Manajemen Arsip - AMAN SIP" name="description">
        ...
        <link href="css/global/light.min.css" rel="stylesheet" type="text/css" id="style_color">
        <link href="css/global/custom.css" rel="stylesheet" type="text/css">
        <!-- END GLOBAL MANDATORY STYLES -->

        <!-- BEGIN PAGE LEVEL PLUGINS -->
        @section('page-level-plugins') @show
        <!-- END PAGE LEVEL PLUGINS -->

        <!-- BEGIN PAGE LEVEL STYLES -->
        @section('page-level-styles') @show
