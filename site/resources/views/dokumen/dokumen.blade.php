...
@section('page-title', 'Dokumen Kegiatan')
...
@section('page-content')
	<div class="page-content">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase">View All Dokumen Kegiatan</span>
                                        </div>
                                        <div class="tools"> </div>
                                    </div>
                                    <?php $no = 1; ?>
                                                    ...
                                                    @foreach ($dokumen as $data)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{ asset(env('STORAGE_PATH') . '\\dokumen\\' . $data->file_kegiatan ) }}" target="_blank" class="btn btn-outline blue">
                    ...
                    @include('dokumen.modals-create-dokumen')
                    @include('dokumen.modals-view-dokumen')
                    @include('dokumen.modals-edit-dokumen')
@endsection
...
<script src="js/pages/dokumen/dokumen.js" type="text/javascript"></script>
@endsection